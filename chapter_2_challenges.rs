// This module contains my solutions to the challenges in chapter 2 of Category
...
// Challenge 4
// Which of these C++ functions are pure? Try to memoize them and observe what
...
// Challenge 5
// How many different functions are there from Bool to Bool? Can you implement
// them all?

// Challenge 6
// Draw a picture of a category whose only objects are the types Void, ()
// (unit), and Bool; with arrows corresponding to all possible functions between
// these types. Label the arrows with the names of the functions.
